# MY RULES
"Keep logic & comments the same, I just want design.”
”Redesign this based on the DESIGN.md (colors, typographies, spacing, border radius, shadow style, etc)when possible and use Tailwind V4, NextJS 16+.”
”Keep the imports and keep using the shadcn/ui classes”
”Make it as good looking as you can while still following the DESIGN.md”
”Don’t use any fonts because it will be auto applied”.
”Make sure it’s responsive for all platforms”


# Design System Inspiration of Notion
## 0. Must follow prompts when redesigning a .tsx component / page:
"Keep logic & comments the same, I just want design.”
”Redesign this based on the DESIGN.md (colors, typographies, spacing, border radius, shadow style, etc) when possible and use Tailwind V4, NextJS 16+.”
”Keep the imports and keep using the shadcn/ui classes”
”Make it as good looking as you can while still following this DESIGN.md”
”Don’t use any fonts because it will be auto applied”.
”Make sure it’s responsive for all platforms”
